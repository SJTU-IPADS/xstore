...
struct XCacheTreeIter : public KeyIterTrait<XCacheTreeIter<N, K, V>, XTree<N,K,V>, K> {
  ...
  XTreeIter<N,K,V> core_iter; // basically, this is a wrapper of the core_iter
  XCacheTT *tt = nullptr;
  u64 logic_page_id = 0;

  using Self = XCacheTreeIter<N,K,V>;

  static auto from_impl(XTree<N,K,V> &kv) -> Self { return Self(kv, nullptr); }
